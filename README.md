...
`delete_account` und `rebuild` schreiben nur Vektoren, `instance_name`, einen
abgeleiteten `account_scope`, `memory_id`, Embedding-Metadaten und
`schema_version` nach Qdrant, keine rohe `account_id`, keine
