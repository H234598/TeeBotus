...
`TELEGRAM_BOT_INSTANCES=all` beziehungsweise `TEEBOTUS_INSTANCES=all` schaltet wieder auf automatische Ordner-Erkennung, statt eine Instanz namens `all` zu starten.
