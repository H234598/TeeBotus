...
def test_extract_residence_city_removes_daypart_context() -> None:
    ...
    assert extract_residence_city("Ich wohne in Berlin. Jetzt lebe ich in Hamburg.") == "Berlin"
    assert extract_residence_city("Mein Wohnort ist Berlin. Jetzt wohne ich in Hamburg.") == "Berlin"
