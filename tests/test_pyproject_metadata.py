...
def test_pyproject_declares_plan1_optional_dependency_groups() -> None:
    ...
    assert set(optional["llm"]) >= {"litellm!=1.82.7,!=1.82.8", "openai", "ollama"}
    assert set(optional["agents"]) >= {"pydantic-ai", "langgraph"}
