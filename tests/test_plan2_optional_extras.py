...
def test_plan2_optional_extras_inventory_reports_declared_groups(monkeypatch) -> None:
    ...
    assert "haystack-ai==2.30.2" in report["extras"]["rag"]["declared"]
    assert "qdrant-haystack==10.3.0" in report["extras"]["rag"]["declared"]
    assert "beautifulsoup4==4.15.0" in report["extras"]["rag"]["declared"]
    ...
    payload = {
        "project": {
            "optional-dependencies": {
                ...
                "rag": ["haystack-ai==2.30.2", "beautifulsoup4==4.15.0"],
        ...
        _toml_for_optional_dependencies(
            {
                ...
                "rag": ["haystack-ai==2.30.2", "beautifulsoup4"],
                "agents": ["pydantic-ai-slim==1.107.0"],
                "tools": ["fastmcp==3.4.2"],
            }
        ),
