...
- Block German modal loudness action variants.
...
- Respect progress and negation in volume adjustments.
...
- Recognize current `been on` and `auf laut` status forms.

## 1.9.146 - 2026-07-12

- Ignore additional epistemically uncertain loudness statements.
...
- Normalize typographic apostrophes in loudness responses.
