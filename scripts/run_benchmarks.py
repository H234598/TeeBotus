...
from TeeBotus.llm.profiles import load_llm_profiles, select_llm_route  # noqa: E402
...
def _benchmark_source_harvester_promote_index_flow(*, iterations: int) -> BenchmarkResult:
...
def _benchmark_hf_pool_eval_matrix(*, iterations: int) -> BenchmarkResult:
    purposes = (
        "structured_decision",
        "normal_chat",
...
def _benchmark_hf_pool_live(*, profile: str = "") -> BenchmarkResult:
...
def _benchmark_qdrant_health_live() -> BenchmarkResult:
